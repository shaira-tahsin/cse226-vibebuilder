import { VibeDashboardPage } from '@/modules/vibebuilder/pages/dashboard/dashboard';
import { EditorPage } from '@/modules/vibebuilder/pages/editor/editor';
import { SiteRendererPage } from '@/modules/vibebuilder/pages/renderer/site-renderer';
